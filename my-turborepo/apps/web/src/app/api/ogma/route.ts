...
// Forces all traffic through Vercel's unified key via the Marketplace endpoint
...
// 2. Define The Trinity (Updated to 2026 Model Standards)
const TRINITY = {
    architect: {
...
export async function POST(req: Request) {
    try {
        ...
        if (user && sessionId) {
            ...
            // Safe extraction of content whether string or array
