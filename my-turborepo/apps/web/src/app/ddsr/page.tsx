...
export default function DDSRPage() {
  ...
  return (
    <div className="flex flex-col min-h-screen bg-background text-foreground">
      ...
      {/* 1. HERO SECTION */}
      <section className="relative w-full h-[90vh] flex flex-col md:flex-row overflow-hidden border-b border-border">
        {/* Left: Real World */}
        ...
        {/* Right: Digital Twin */}
        <div className="relative w-full md:w-1/2 h-1/2 md:h-full group border-t md:border-t-0 md:border-l border-border">
          <Image
          ...
          <div className="absolute inset-0 flex items-center justify-center">
             <h2 className="text-4xl md:text-6xl font-bold text-foreground tracking-tighter uppercase opacity-80 select-none">
              Digital
            </h2>
          </div>
        </div>
        ...
        <div className="absolute inset-0 flex flex-col items-center justify-center z-10 pointer-events-none px-4 text-center">
          <div className="bg-background/80 backdrop-blur-md p-8 rounded-2xl border border-border shadow-2xl max-w-4xl">
      ...
      <section className="py-24 px-6 md:px-12 bg-card border-b border-border">
        <div className="container mx-auto max-w-6xl grid grid-cols-1 md:grid-cols-2 gap-16 items-center">

          {/* Visual: Shopping Cart */}
          <div className="relative">
            <Card className="w-full max-w-md mx-auto shadow-xl border-muted relative z-10">
              ...
              <CardFooter>
                ...
                <Button className="w-full relative overflow-hidden group">
                   Proceed to Checkout
                   <span className="absolute inset-0 bg-background/80 flex items-center justify-center font-bold text-destructive translate-y-full group-hover:translate-y-0 transition-transform duration-300">
                     WAIT!
                   </span>
                </Button>
              </CardFooter>
            ...
            <div className="absolute -bottom-12 -right-12 w-64 h-64 bg-secondary/20 rounded-full blur-3xl z-0" />
          </div>
          ...
          <div className="space-y-8">
            ...
            <div className="space-y-4 text-lg text-muted-foreground">
              ...
              <p className="font-medium text-foreground border-l-4 border-primary pl-4 py-2 bg-secondary/50 rounded-r">
        ...
        <div className="container mx-auto max-w-4xl text-center space-y-12">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8 py-8">
            <div className="p-6 rounded-xl bg-card border border-border shadow-sm">
              ...
              <h4 className="font-bold text-xl mb-2">Install it Digitally.</h4>
            ...
            <div className="p-6 rounded-xl bg-card border border-border shadow-sm">
              ...
              <h4 className="font-bold text-xl mb-2">Thrash it Virtually.</h4>
            ...
            <div className="p-6 rounded-xl bg-card border border-border shadow-sm">
              ...
              <h4 className="font-bold text-xl mb-2">Buy it Physically.</h4>
        ...
        <div className="container mx-auto max-w-6xl">
          <div className="grid grid-cols-1 md:grid-cols-3 gap-12">
            ...
            <div className="flex flex-col items-center text-center space-y-4">
              ...
              <h4 className="text-2xl font-bold">The Soul File Protocol</h4>
            ...
            <div className="flex flex-col items-center text-center space-y-4">
              ...
              <h4 className="text-2xl font-bold">Asynchronous Competition</h4>
              <p className="text-muted-foreground leading-relaxed">
            ...
            <div className="flex flex-col items-center text-center space-y-4">
              ...
              <h4 className="text-2xl font-bold">Verified Ownership Racing</h4>
              <p className="text-muted-foreground leading-relaxed">
      ...
      <section className="py-32 px-6 bg-background relative overflow-hidden">
        <div className="container mx-auto max-w-2xl text-center space-y-8 relative z-10">
          ...
          <div className="pt-4">
            <Button size="lg" className="text-lg px-8 py-6 h-auto shadow-lg shadow-primary/20" onClick={handleJoinClick}>
