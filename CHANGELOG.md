...
[2025-02-26] [Database] [FIX] Updated get_unique_vehicles_with_trims function to use an Expression Index (GIN) on to_tsvector to ensure query plan alignment and prevent backfill timeouts (Fixed dependency error during cleanup).
