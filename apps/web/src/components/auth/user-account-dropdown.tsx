            ...
            <div className="p-1">
              ...
              {onReportProblem && (
                <button
                  ...
                  className="flex items-center gap-2 px-3 py-2 text-sm text-popover-foreground hover:bg-accent hover:text-accent-foreground rounded-md transition-all w-full text-left border border-accent shadow-lg shadow-accent/60"
                >
                  <AlertCircle size={16} />
