...
export default function DDSRPage() {
  ...
  return (
    <div className="flex flex-col min-h-screen bg-gradient-orbital text-foreground">
      ...
      <section className="relative w-full h-[90vh] flex flex-col md:flex-row overflow-hidden border-b border-white/10">
        ...
        <div className="absolute inset-0 flex flex-col items-center justify-center z-10 pointer-events-none px-4 text-center">
          <div className="bg-background/60 backdrop-blur-md p-8 rounded-2xl border border-border/10 shadow-2xl max-w-4xl">
            <h1 className="text-4xl md:text-7xl font-bold tracking-tight mb-4 text-foreground">
            ...
            <p className="text-lg md:text-2xl text-muted-foreground font-light">
              The first platform where your <span className="font-medium text-foreground">physical VIN</span> controls your <span className="font-medium text-foreground">digital physics</span>.
            </p>
          </div>
        </div>
      </section>
      ...
      <section className="py-24 px-6 md:px-12 bg-background/40 backdrop-blur-sm border-b border-border/10">
        <div className="container mx-auto max-w-6xl grid grid-cols-1 md:grid-cols-2 gap-16 items-center">

          {/* Visual: Shopping Cart */}
          <div className="relative">
            <Card className="w-full max-w-md mx-auto shadow-xl border-border/10 bg-background/60 text-foreground relative z-10">
              <CardHeader className="flex flex-row items-center justify-between space-y-0 pb-2 border-b border-border/10">
                ...
                <Badge variant="outline" className="border-border/20 text-foreground">Guest</Badge>
              </CardHeader>
              <CardContent className="pt-6 space-y-6">
                <div className="flex justify-between items-start">
                  <div>
                    <p className="font-semibold text-foreground">Garrett G25-550 Turbo Kit</p>
                ...
                <div className="flex justify-between items-start">
                  <div>
                    <p className="font-semibold text-foreground">KW V3 Coilover Kit</p>
                    <p className="text-sm text-muted-foreground">Est. Delivery: 2 weeks</p>
                  </div>
                  <p className="font-mono font-medium">$1,789.50</p>
                </div>

                <div className="border-t border-border/10 pt-4 flex justify-between items-center font-bold text-lg">
                  <span>Total</span>
                  <span>$4,285.49</span>
                </div>
              </CardContent>
              <CardFooter>
                {/* Visual only button */}
                <Button className="w-full relative overflow-hidden group bg-card text-foreground hover:bg-card/80">
                  Proceed to Checkout
                  <span className="absolute inset-0 bg-destructive/90 text-foreground flex items-center justify-center font-bold translate-y-full group-hover:translate-y-0 transition-transform duration-300">
                    WAIT!
                  </span>
                </Button>
              </CardFooter>
            ...
            <div className="absolute -top-12 -left-12 w-64 h-64 bg-primary/20 rounded-full blur-3xl z-0" />
          ...
          <div className="space-y-8">
            <h2 className="text-3xl md:text-4xl font-bold leading-tight text-foreground">
              You're about to drop <span className="text-primary">$4k</span> on a new suspension and turbo setup.
            </h2>
            <div className="space-y-4 text-lg text-muted-foreground">
              ...
              <p className="font-medium text-foreground border-l-4 border-primary pl-4 py-2 bg-primary/10 rounded-r">
      ...
      <section className="py-24 px-6">
        <div className="container mx-auto max-w-4xl text-center space-y-12">
          ...
          <div className="space-y-6">
            <h2 className="text-sm font-bold tracking-widest text-primary uppercase">The Solution</h2>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8 py-8">
            <div className="p-6 rounded-xl bg-background/40 border border-border/10 shadow-lg backdrop-blur-sm">
              <div className="mb-4 text-primary flex justify-center">
                <Monitor className="w-10 h-10" />
              </div>
              <h4 className="font-bold text-xl mb-2 text-foreground">Install it Digitally.</h4>
              <p className="text-sm text-muted-foreground">Upload the specs of that new turbo kit to your Digital Twin.</p>
            </div>
            <div className="p-6 rounded-xl bg-background/40 border border-border/10 shadow-lg backdrop-blur-sm">
              <div className="mb-4 text-primary flex justify-center">
                <Gamepad2 className="w-10 h-10" />
              </div>
              <h4 className="font-bold text-xl mb-2 text-foreground">Thrash it Virtually.</h4>
              <p className="text-sm text-muted-foreground">Take it to the Nürburgring. Push it to the absolute limit.</p>
            </div>
            <div className="p-6 rounded-xl bg-background/40 border border-border/10 shadow-lg backdrop-blur-sm">
              <div className="mb-4 text-primary flex justify-center">
                <Banknote className="w-10 h-10" />
              </div>
              <h4 className="font-bold text-xl mb-2 text-foreground">Buy it Physically.</h4>
              <p className="text-sm text-muted-foreground">If it feels right, buy the parts. If not, you just saved $4k.</p>
            </div>
          </div>
      ...
      <section className="py-24 px-6 bg-background/20 border-y border-border/10 backdrop-blur-sm">
        <div className="container mx-auto max-w-6xl">
          <div className="grid grid-cols-1 md:grid-cols-3 gap-12">
            ...
            <div className="flex flex-col items-center text-center space-y-4">
              ...
              <h4 className="text-2xl font-bold text-foreground">The Soul File Protocol</h4>
            ...
            <div className="flex flex-col items-center text-center space-y-4">
              ...
              <h4 className="text-2xl font-bold text-foreground">Asynchronous Competition</h4>
              <p className="text-muted-foreground leading-relaxed">
            ...
            <div className="flex flex-col items-center text-center space-y-4">
              ...
              <h4 className="text-2xl font-bold text-foreground">Verified Ownership Racing</h4>
              <p className="text-muted-foreground leading-relaxed">
      ...
      <section className="py-32 px-6 relative overflow-hidden border-t border-border/10">
        ...
        <div className="absolute inset-0 z-0">
          ...
          />
          <div className="absolute inset-0 bg-background/70" /> {/* Dark tint overlay */}
        </div>
        ...
        <div className="container mx-auto max-w-2xl text-center space-y-8 relative z-10">
          ...
          <div className="pt-4">
            <Button size="lg" className="text-lg px-8 py-6 h-auto shadow-lg shadow-primary/20 bg-card text-foreground hover:bg-card/80" onClick={handleJoinClick}>
      ...
      {/* FOOTER */}
      <footer className="py-12 bg-background/60 border-t border-border/10 text-center backdrop-blur-md">
